...
\citem{University of Ottawa}, Ottawa, Canada (2015 -- Present)
\begin{itemize}
\item Bachelor of Science in Software Engineering
\item Anticipated Graduation in December of 2018
\end{itemize}
\end{category}

\begin{category}{Awards \&\\ Achieved}
  \citemnotbold{ Selected to present Swift WALA at OOPSLA (2018) }
...
\begin{category}{Skills}
  ...
  \citemnobullet{%
    ...
    \skill{Bamboo CI}
    \newline
    \skill{\textbf{HTML/CSS/JavaScript}}
    \skill{Learning Rust}
    \skill{\textbf{Kotlin}}
    \skill{Android}
  }
...
\citem{WALA}, University of Ottawa (01/2018 -- Present)\\
...
Designed and implemented an interpreter capable of running Chip8 programs in Swift.
...
\citem {Java CookTime}, Personal/Open Source (2016)\\
 by a SQLite database. This project was a component of my degree program.
\end{category}
