...
Developed the Stripe Mobile Dashboard application where zsmerchants can visualize thier business
with comprehensive charts, manage subscriptions and take payments
directly on thier device with Tap To Pay.
